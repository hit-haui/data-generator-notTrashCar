...
def main():
    ...
    prox_sub = rospy.Subscriber("ss_status", bool, sensor_callback)

    ts = message_filters.Aptest_sensor.pyproximateTimeSynchronizer(
        [rgb_sub, depth_sub, prox_sub], queue_size=1, slop=0.1)
